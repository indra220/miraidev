...
export default function SeoManagement() {
  ...
  const [seoData, setSeoData] = useState<FormSeoSettings[]>([
    ...
    },
    {
      ...
      keywords: "portofolio web, contoh website, proyek web, mirai dev",
      ogTitle: "Portofolio Proyek Web Development",
      ogDescription: "Lihat contoh proyek web yang berhasil kami kerjakan",
      ogImage: "https://miraidev.id/og-image-portfolio.jpg",
      twitterTitle: "Portofolio Proyek Web Development",
      twitterDescription: "Lihat karya terbaik kami",
      twitterImage: "https://miraidev.id/twitter-image-portfolio.jpg",
      canonicalUrl: "https://miraidev.id/portofolio",
      robotsIndex: true,
      robotsFollow: true,
      sitemapPriority: 0.8,
